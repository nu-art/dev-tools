...
class GitCli
    ...
    GitCli runInRepoFolder(boolean runInRepoFolder) {
        this.runInRepoFolder = runInRepoFolder;
        return this
    }
    ...
    String execute(output = false) {
        if (this.runInRepoFolder)
            return repo.sh(this, output)
